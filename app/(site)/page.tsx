...
const HomePage = () => {
  return (
    <>
      ...
      <section className="px-4 sm:px-6 justify-center flex items-center flex-col relative">
      ...
      <section className="mt-20 px-4 sm:px-6">
        <TitleSection
          ...
          subheading="Experience all the benefits of our platform. Select a plan that suits your needs and take your productivity to the next level."
          pill="Pricing"
        />
              ...
              cardContent={
                <CardContent className="p-0">
                  ...
                  <Button
                    ...
                    className={
                      card.planType === PRICING_PLANS.proplan
                        ? "whitespace-nowrap w-full mt-4 hover:bg-washed-purple-600/10"
                        : "whitespace-nowrap w-full mt-4"
                    }
                  >
                    {card.planType === PRICING_PLANS.proplan
                      ? "Go Pro 💎"
